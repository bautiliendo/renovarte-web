        ...
        <div className='w-full bg-white py-32 px-4 h-[450px]'>
          <div className='max-w-[1240px] mx-auto grid '>
            <div className='flex flex-col justify-center'>
              ...
              <p className='my-8'>
              Si quieres hacer una compra o consultar acerca del precio y detalles de un producto, selecciona el producto que te interese y haz click en el botón <strong>Añadir al carrito</strong>, Luego dirigete al mismo y haz click en el botón <strong>Consultar.</strong> Nuestro equipo se pondrá en contacto contigo!
              </p>
